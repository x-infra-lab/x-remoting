...
//
// @Slf4j
// public class RpcRequestMessageProcessor extends
// AbstractMessageProcessor<RemotingMessage> {
//
// @Override
// public void handleMessage(MessageHandlerContext messageHandlerContext, RemotingMessage
...
// messageHandlerContext.getUserProcessor(message.getContentType());
// if (userProcessor == null) {
// String errorMsg = String.format("No userProcessor for content-type: %s",
// message.getContentType());
// log.error(errorMsg);
// sendResponse(messageHandlerContext, requestMessage,
// messageHandlerContext.getMessageFactory().createExceptionResponse(message.id(),
// errorMsg));
// return;
// }
//
...
// }
//
// processorExecutor.execute(new ProcessTask(userProcessor, requestMessage,
// messageHandlerContext));
// }
//
// private void process(MessageHandlerContext messageHandlerContext, UserProcessor
// userProcessor,
...
// sendResponse(messageHandlerContext, requestMessage,
// messageHandlerContext.getMessageFactory().createResponse(requestMessage.id(),
// responseContent));
// }
// finally {
...
// }
//
// private boolean deserialize(MessageHandlerContext messageHandlerContext,
// RemotingRequestMessage requestMessage,
...
// }
// catch (Throwable t) {
// log.error("Deserialize message fail. id:{} deserializeLevel:{}", requestMessage.id(),
// level, t);
//
...
//
// public ProcessTask(UserProcessor<?> userProcessor, RemotingRequestMessage
// requestMessage,
