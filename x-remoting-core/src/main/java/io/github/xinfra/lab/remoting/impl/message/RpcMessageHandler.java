...
import io.github.xinfra.lab.remoting.impl.processor.MessageProcessor;
import io.github.xinfra.lab.remoting.impl.processor.UserProcessor;
import io.github.xinfra.lab.remoting.impl.processor.RpcHeartbeatMessageProcessor;
import io.github.xinfra.lab.remoting.impl.processor.RpcRequestMessageProcessor;
import io.github.xinfra.lab.remoting.impl.processor.RpcResponseMessageProcessor;
...
import static io.github.xinfra.lab.remoting.impl.message.RpcMessageType.heartbeatRequest;
import static io.github.xinfra.lab.remoting.impl.message.RpcMessageType.request;

@Slf4j
public class RpcMessageHandler implements MessageHandler {

	private ConcurrentHashMap<RpcMessageType, MessageProcessor<RemotingMessage>> messageProcessors = new ConcurrentHashMap<>();
